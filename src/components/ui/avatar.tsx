...
function Avatar({
  ...
  return (
    <AvatarPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "group/avatar relative flex h-8 w-8 shrink-0 rounded-full select-none after:absolute after:inset-0 after:rounded-full after:border after:border-border data-[size=lg]:h-10 data-[size=lg]:w-10 data-[size=sm]:h-6 data-[size=sm]:w-6",
        className
      )}
      {...props}
    />
  ...
  return (
    <span
      ...
      className={cn(
        ...
        "h-2.5 w-2.5 [&>svg]:h-2 [&>svg]:w-2 group-data-[size=sm]/avatar:h-2 group-data-[size=sm]/avatar:w-2 group-data-[size=sm]/avatar:[&>svg]:hidden group-data-[size=lg]/avatar:h-3 group-data-[size=lg]/avatar:w-3",
        className
      )}
      {...props}
    />
